...
namespace Shop.Areas.Admin.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        private readonly IDataService<DomainModel.User> _usercontext;

        public OrdersController(IDataService<Order> context, IDataService<DomainModel.User> usercontext)
        {
            _context = context;
        ...
        {
            var ShopContext = _context.GetAll();
